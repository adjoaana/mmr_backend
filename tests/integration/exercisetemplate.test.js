...
beforeEach(async () => {
  ...
  healthProfessionalType = await healthProfessionalTypeService.create(
    new_healthProfessionalType
  );
  ...
  healthProfessional_token = AuthenticationManager.createToken(
    healthProfessional_body
  );
