...
class TemplateService extends Service {
    ...
    updateTemplateExerciseStatus = async ({ user_id, _id, prescriptionId, status, patientComment }) => {
		const response = await this.Model.findOneAndUpdate(
    ...
    deleteOneUserTemplate = async (user_id, template_id) => {
		const result = await this.Model.deleteOne({ _id: template_id, $or: [{ patient: user_id }, { healthProfessional: user_id }] });
